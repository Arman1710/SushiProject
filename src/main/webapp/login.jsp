    ...
    <div class="backside" style="background-image: url(images/loginBG.jpg)">
        <div class="block">
                ...
                <form action="Controller" method="post">
                    ...
                    <c:choose>
                        <c:when test="${sessionScope.locale.toString() == 'ru_KZ'}">
                            ...
                            <input type="hidden" name="currentPage" value="login.jsp"/>
            ...
            <form action="Controller" method="post">
                ...
                <div class="textReg">
                    <a class="registration" href="registration.jsp">
                            <fmt:message key="registration"/>
                    </a>
                </div>
            </form>
            <div class="loginLikeGuest-div">
                <form action="Controller" method="post">
                    <input type="hidden" name="action" value="loginLikeGuest"/>
                    <button class="loginLikeGuest" type="submit" >
